...
from reference.calibration import CalibrationPoint

_CHECKPOINT_S = 600  # 10-minute game clock (reference.in_game_checkpoint)
...
def build_points(oe_paths: list[str], *, kalshi: KalshiAdapter | None = None,
    ...
    for m in oe:
        ...
        if gamelen and gamelen >= _CHECKPOINT_S:
            targets[CONFIG.regimes.IN_GAME] = kickoff + _CHECKPOINT_S
